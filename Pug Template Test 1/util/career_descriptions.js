exports.careers = [
        ...
        card: `We’re looking for a self-starting professional with managerial experience and a proven track record in sales. The ideal candidate will look forward to coming to work each day and helping our customers find the applications that work best for them.`,
    ...
    },
    {
        ...
        card: `Senior Web Developer's responsibilities include communicating with clients to determine website specifications, writing code, working with a team of designers and content writers, as well as assisting with recruitment and training of all new junior web developers.`,
    ...
    },
    {
        ...
        card: `As a Junior Web Developer you will spend a significant portion of your time coding and documenting in a team lead by a Senior Developer.`,
    ...
    },
    {
        ...
        card: `The Graphic designer creates visual concepts, by hand or using computer software, to communicate ideas that inspire, inform, or captivate consumers.`,
    ...
    
    {
        ...
        responsibilities: [
            ...
            `Establish a referral network with local businesses and find ways to maximize value from those connections`,
...

    {
        ...
        card: `Internet marketing managers are responsible for creating and implementing online marketing strategies to increase sales and revenue for a company.`,
...

    {
        ...
        card: `Our organization’s Customer Service Manager focuses on all aspects of customer satisfaction and care as well as the supervision of our dedicated Customer Service Associates.`,
        ...
        responsibilities: [
            ...
            `Interact with customers on a daily basis, responding to complaints and queries (from customers and staff) and guiding them to the appropriate service`,
...

    {
        ...
        card: `Back-End Web Developer is responsible for managing the interchange of data between the server and the users.`,
        ...
        skills: [
            ...
            `Depending on the specific case, a developer should have the knowledge of one or more of PHP, Python, Ruby, Java, .NET, JavaScript`,
...

    {
        ...
        card: `Social Media Coordinator is responsible for planning, implementing and monitoring a company's Social Media strategy in order to increase brand awareness, improve Marketing efforts and increase sales.`,
        ...
        skills: [
            ...
            `BA in Marketing or similar relevant field a plus`,
...

    {
        ...
        card: `This role will direct the Creative Content Team creative content execution across multiple lines of business and departments; including but not limited to theatrical marketing EPK and publicity content, digital/social content, specialty broadcast content.`,
